package com.pdm.runique.run.presentation.active_run.service
...
class ActiveRunService : Service() {
    ...
    private val baseNotification by lazy {
        NotificationCompat.Builder(applicationContext, CHANNEL_ID)
            .setSmallIcon(com.pdm.runique.core.presentation.designsystem.R.drawable.logo)
            .setContentTitle(
    ...
    private fun createNotificationChannel() {
        val channel = NotificationChannel(
            CHANNEL_ID,
            getString(R.string.active_run), NotificationManager.IMPORTANCE_DEFAULT
        )
